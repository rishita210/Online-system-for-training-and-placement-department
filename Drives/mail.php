		...
		<div class="container">
			...
			<div class="mail-grids">
				<div class="col-md-6 mail-grid-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Contact Us</h3>	
					<p></p>				
					<h4>Projectworlds Institute of Technology</h4>
					<p>RAIPUR,DURG,
						<span>NEHRU NAGAR, BHILAI, CHHATTISGARH</span>
						India IN-490021
					</p>
					<h4>Get In Touch</h4>
					<p>Telephone: +917000830947/223365
						<span>FAX: +91 7000830947</span>
						E-mail: <a href="mailto:citcollege@rediffmail.com">Projectworldsofficial@gmail.com</a>
					</p>
				</div>
